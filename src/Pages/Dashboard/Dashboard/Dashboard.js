...
import { faCartPlus, faCogs, faCreditCard, faPlusSquare, faTasks, faUserCog, faUserShield } from '@fortawesome/free-solid-svg-icons';
                        ...
                        <ProSidebar collapsed={menuCollapse}>
                            <SidebarHeader>
                                <div className="logotext pt-3">
                                    ...
                                    <p>{menuCollapse ? "Menu" : "Hero Moto"}</p>
                                </div>
                                    ...
                                    <Menu iconShape="square">
                                        ...
                                        <MenuItem >
                                            <Link className="text-decoration-none" to={`${url}/manageAllPurchases`}>
                                                <FontAwesomeIcon icon={faCogs} /> Manage All Order's</Link>
                                        </MenuItem>
                                    </Menu>
                                </SidebarContent>
                            }
                                ...
                                <Menu iconShape="square">
                                    ...
                                    <MenuItem>
                                        <Link className="text-decoration-none" to={`${url}/payment`}>
                                            <FontAwesomeIcon icon={faCreditCard} /> Payment </Link>
                                    </MenuItem>
                            ...
                            <SidebarFooter>
                                <Menu iconShape="square">
                                    <MenuItem icon={<FiLogOut />}>
                                        <li onClick={logOut} className="dashboard-menu-item text-decoration-none"> Logout </li>
                                    </MenuItem>
                                </Menu>
                            </SidebarFooter>
                        </ProSidebar>
