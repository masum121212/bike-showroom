...
const ManageAllPurchases = () => {
    ...
    return (
        <div className="container-fluid py-5">
            <h1 className="pt-5 fw-bold text-primary">Manage All Order's</h1>
            <h5 className=" pt-3 text-primary">Users Total Order list: <span className="text-dark">{managePurchases?.length}</span> </h5>
                    ...
                    {managePurchases.map((managePurchase) => (
                        ...
                        <tbody key={managePurchase._id}>
                            <tr>
                                ...
                                {Array.from({ length: 1 }).map((_, index) => (
                                    <td key={index}>
                                        <button onClick={() => deleteHandle(managePurchase?._id)} className="border-0 text-dark">
